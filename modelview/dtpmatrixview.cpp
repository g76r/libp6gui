...
void DtpMatrixView::setMouseoverTarget(QByteArray itemId)  {
  if (itemId.isNull())
...
QByteArrayList DtpMatrixView::mouseoverItemsIds() const {
  QAbstractItemModel *m = model();
...
bool DtpMatrixView::startItemEdition(QByteArray qualifiedId) {
